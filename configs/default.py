...
_CN.LOFTR.RESNETFPN.TOPIC_NUM = 5
...
_CN.LOFTR.COARSE.BLOCK_DIMS = [128, 196, 256]  # s1, s2, s3
...
_CN.LOFTR.COARSE.D_MODEL_FUSION = 256
_CN.LOFTR.COARSE.D_FFN = 256
_CN.LOFTR.COARSE.NHEAD = 8
_CN.LOFTR.COARSE.THR = 0.2
_CN.LOFTR.COARSE.LAYER_NAMES = ['self', 'cross'] * 5
_CN.LOFTR.COARSE.LAYER_NAMES_T = ['seed'] * 5
_CN.LOFTR.COARSE.LAYER_NAMES_R = ['rea'] * 3
_CN.LOFTR.COARSE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.COARSE.N_TOPICS = _CN.LOFTR.RESNETFPN.TOPIC_NUM
_CN.LOFTR.COARSE.N_SAMPLES = 3
