...
_CN.LOFTR.RESNETFPN.IMG_SIZE = 320
_CN.LOFTR.RESNETFPN.TOPIC_NUM = _CN.LOFTR.RESNETFPN.IMG_SIZE // 64
# _CN.LOFTR.RESNETFPN.BLOCK_DIMS = [128, 160, 192, 256]  # s1, s2, s3
_CN.LOFTR.RESNETFPN.BLOCK_DIMS = [128, 160, 192, 192]  # s1, s2, s3

# 2. LoFTR-coarse module config
_CN.LOFTR.COARSE = CN()
_CN.LOFTR.COARSE.D_MODEL = 192
# _CN.LOFTR.COARSE.BLOCK_DIMS = [128, 160, 192, 256]  # s1, s2, s3
_CN.LOFTR.COARSE.BLOCK_DIMS = [128, 160, 192, 192]  # s1, s2, s3
_CN.LOFTR.COARSE.INITIAL_DIM = 128
_CN.LOFTR.COARSE.IMG_SIZE = _CN.LOFTR.RESNETFPN.IMG_SIZE
_CN.LOFTR.COARSE.TOPIC_NUM = _CN.LOFTR.RESNETFPN.TOPIC_NUM
_CN.LOFTR.COARSE.RELATOR_DIM_INI = 1
_CN.LOFTR.COARSE.D_MODEL_FUSION = 192
_CN.LOFTR.COARSE.D_FFN = 192
_CN.LOFTR.COARSE.NHEAD = 8
# _CN.LOFTR.COARSE.THR = 0
_CN.LOFTR.COARSE.THR = 0.2
_CN.LOFTR.COARSE.LAYER_NAMES = ['self', 'cross'] * 3
_CN.LOFTR.COARSE.LAYER_NAMES_T = ['seed'] * 3 + ['seed', 'feat'] * 3
# _CN.LOFTR.COARSE.LAYER_NAMES_T = ['seed'] * 3
# _CN.LOFTR.COARSE.LAYER_NAMES_f = ['seed','feat'] * 1
_CN.LOFTR.COARSE.LAYER_NAMES_f = ['seed', 'feat'] * 0
_CN.LOFTR.COARSE.IMG_SIZE = _CN.LOFTR.RESNETFPN.IMG_SIZE
_CN.LOFTR.COARSE.LAYER_NAMES_T1 = ['seed', 'feat'] * 3
_CN.LOFTR.COARSE.LAYER_NAMES_T2 = ['seed', 'feat'] * 3
_CN.LOFTR.COARSE.LAYER_NAMES_T3 = ['seed', 'feat'] * 5
_CN.LOFTR.COARSE.LAYER_NAMES_R = ['rea'] * 3
_CN.LOFTR.COARSE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.LOFTR.COARSE.N_TOPICS = 25
_CN.LOFTR.COARSE.N_SAMPLES = 25
_CN.LOFTR.COARSE.N_TOPIC_TRANSFORMERS = 1
_CN.LOFTR.COARSE.TEMP_BUG_FIX = True

# 3. Coarse-Matching config
_CN.LOFTR.MATCH_COARSE = CN()
# _CN.LOFTR.MATCH_COARSE.THR = 0
